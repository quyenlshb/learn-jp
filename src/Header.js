    ...
    <header className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-lg sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3">
          <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M6 7h12" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
          <span className="text-2xl font-extrabold tracking-tight">LearnJP</span>
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm font-medium">
          ...
          <button onClick={handleLogout} className="ml-3 bg-white/10 hover:bg-white/20 px-3 py-1.5 rounded-lg">
            Đăng xuất
          </button>
        </nav>
